...
import (
	"github.com/egespindola/ecommerce/internal/database"
...
func (ps *ProductService) CreateCategory(name, description, category_id, image_url string, price float64) (*entity.Product, error) {
